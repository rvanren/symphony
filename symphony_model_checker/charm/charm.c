// Main source file for the Symphony model checker.  It contains the main
...
struct worker {
    ...
    // followed by its stack of Symphony values.
    struct context ctx;
...
// Part of experimental -d option, running Symphony programs "for real".
            ...
            // Worker 0 periodically prints some stats for long runs.
                ...
                if (last_time != 0) {
                    ...
                    if (compute_percentage < 25) {
                        ...
                        fprintf(stderr, ": spending much time evaluating Symphony code in different states\n");
                    }
