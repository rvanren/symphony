...
// This contains the state in a Symphony execution.
//
...
// A context is the state of a Symphony thread.  The stack, which is part of the
...
// A Symphony value is represented by a 64 bit representation.  Currently the
