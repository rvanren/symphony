...
// Invariants are compiled into Symphony code (terminated by an Assert instruction)
...
// Info about a microstep, which is the execution of a single Symphony instruction
...
struct global {
    struct code code;               // code of the Symphony program
    ...
    struct dict *computations;      // evaluated Symphony byte code
