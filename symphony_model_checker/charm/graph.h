...
// A variable is identified by a list of "indices" (simply Symphony values),
...
// Result of onestep().
// We maintain the number of microsteps (Symphony instructions that were executed)
...
// by the array of outgoing edges and then the Symphony state corresponding to this node.
struct node {
